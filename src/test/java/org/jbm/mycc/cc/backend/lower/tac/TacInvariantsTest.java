...
import org.jbm.mycc.cc.backend.lower.tac.*;
...
import static org.jbm.mycc.cc.backend.lower.tac.TacTest.AT;
import static org.jbm.mycc.cc.backend.lower.tac.TacTest.X64;
...
class TacInvariantsTest {
    ...
    private static org.jbm.mycc.cc.backend.lower.tac.Module module(Consumer<Function> body) {
        var m = new org.jbm.mycc.cc.backend.lower.tac.Module(X64);
        ...
        m.funcDecls.add(new org.jbm.mycc.cc.backend.lower.tac.Module.FuncDecl("sq", I_I));
    ...
    void globals() {
        ...
        var bad = new org.jbm.mycc.cc.backend.lower.tac.Module(X64);
