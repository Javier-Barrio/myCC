...
class TacTest {
    ...
    void everyNamedThingIsASymbol() {
        ...
        m.globalDecls.add(new org.jbm.mycc.cc.backend.lower.tac.Module.GlobalDecl("errno", Type.I32));
        var sig = new Type.Func(List.of(Type.PTR), true, Type.I32);
        m.funcDecls.add(new org.jbm.mycc.cc.backend.lower.tac.Module.FuncDecl("printf", sig));
    ...
    void theExampleModulePrints() {
        ...
        m.funcDecls.add(new org.jbm.mycc.cc.backend.lower.tac.Module.FuncDecl("printf", new Type.Func(List.of(Type.PTR), true, Type.I32)));
